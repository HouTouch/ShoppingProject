<template>
  <div class="pay">
    ...
    <div class="address">
      ...
      <div class="info" v-if="addressList.length > 0 " @click="$router.push('/address')">
        <div class="info-content">
          <span class="name">{{adressShow.name}}</span>
          <span class="mobile">{{adressShow.phone}}</span>
        </div>
        <div class="info-address">
          {{longAddress}}
        </div>
      </div>
      <div v-else @click="$router.push('/address')">
        <div class="info" >
          请选择配送地址
        </div>
    ...
    <div class="pay-list" v-if="order.goodsList">
      ...
      <div class="pay-detail">
        ...
        <div class="pay-cell">
          <span>配送费用：</span>
          <span v-if="!adressShow">请先选择配送地址</span>
      ...
      <!-- 买家留言 -->
      <div class="buytips">
        <textarea placeholder="选填：买家留言（50字内）" name="" id="" cols="30" rows="10" v-model="reamrk"></textarea>
      </div>
    </div>
